...
{
   if(idx >= size)
      gPlatform->fatalError("qstring::charAt: index out of range");
...
{
   if(idx >= size)
      gPlatform->fatalError("qstring::operator []: index out of range");
...
qstring &qstring::insert(const char *insertstr, size_t pos)
{
   ...
   if(pos >= index)
      gPlatform->fatalError("qstring::insert: position out of range");
...
qstring &qstring::truncate(size_t pos)
{
   ...
   if(pos >= index)
      gPlatform->fatalError("qstring::truncate: position out of range");
...
qstring &qstring::erase(size_t pos, size_t n)
{
   ...
   // pos must be between 0 and qstr->index - 1
   if(pos >= index)
      gPlatform->fatalError("qstring::erase: position out of range");
...
size_t qstring::find(const char *s, size_t pos) const
{
   ...
   if(pos >= index)
      gPlatform->fatalError("qstring::find: position out of range");
